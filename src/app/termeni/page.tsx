    ...
    <div className="pt-32 pb-20 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-gray-300">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">1. Acceptarea termenilor</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">2. Descrierea serviciului</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">3. Înregistrare și cont</h2>
            <h3 className="text-xl font-semibold text-white mt-6 mb-3">3.1. Waitlist</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-white mt-6 mb-3">3.2. Parteneri</h3>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">4. Utilizarea serviciului</h2>
            <p>Vă angajați să:</p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">5. Proprietate intelectuală</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">6. Confidențialitate</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">7. Limitarea răspunderii</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">8. Modificări ale serviciului</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">9. Reziliere</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">10. Legea aplicabilă</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">11. Modificări ale termenilor</h2>
            <p>
          ...
          <section>
            ...
            <ul className="list-none space-y-2 mt-4">
              <li>Email: <a href="mailto:hello@crwd.ro" className="text-purple-400 hover:text-purple-300 underline">hello@crwd.ro</a></li>
            </ul>
          </section>
        </div>
      </div>
