        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-white/10 py-4">
            <div className="flex flex-col space-y-4 items-center">
              <Link
                href="/parteneri"
                className="text-white hover:text-black hover:[-webkit-text-stroke:0.5px_white] transition-all duration-300 text-3xl font-gotham-condensed font-bold tracking-tight uppercase"
