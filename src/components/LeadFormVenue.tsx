...
export default function LeadFormVenue() {
  ...
  if (state === "success") {
    return (
      <LiquidGlass tone="purple" elevation={2} border="glow" className="p-8 text-center rounded-2xl">
  ...
  return (
    <LiquidGlass tone="neutral" elevation={2} className="p-6 md:p-8 rounded-2xl max-w-md mx-auto">
      <form onSubmit={onSubmit} className="space-y-4">
        <div>
        <label htmlFor="contact_name" className="block text-xs font-gotham-condensed font-semibold text-white mb-2 uppercase tracking-wider">
          Nume contact *
        </label>
        <input
          type="text"
      ...
      <div>
        <label htmlFor="phone" className="block text-xs font-gotham-condensed font-semibold text-white mb-2 uppercase tracking-wider">
          Telefon
        </label>
        <input
          type="tel"
